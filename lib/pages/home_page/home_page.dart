...
import 'package:pokedex_flutter/pages/home_page/widgets/app_home_bar.dart';
import 'package:pokedex_flutter/pages/home_page/widgets/poke_item.dart';
import 'package:pokedex_flutter/pages/poke_detail/poke_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: <Widget>[
          Positioned(
            top: MediaQuery.of(context).padding.top - 240 / 3.5,
                                    ...
                                    return AnimationConfiguration.staggeredGrid(
                                        ...
                                        child: ScaleAnimation(
                                          child: GestureDetector(
                                            ...
                                            onTap: () {
                                              _pokemonStore.setPokemonCurrent(
                                                  index: index);
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
